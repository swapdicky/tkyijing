    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div ref={stickyTitlesRef} style={{
          ...
          <div className="section-title-row">
            <h1 className="text-white fw-300 section-title-text yj-lh-12" style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Acknowledgement</h1>
          </div>
        </div>
        ...
        >
          <div className="ct-left-content" style={{ 
            ...
            <div className="yj-cn-16 yj-lh-14" style={{
              fontWeight: 300,
              color: '#fff',
              textAlign: 'left',
              marginBottom: '1em'
              ...
              <p style={{ marginBottom: '1em' }}>
                我們向所有協助及參與本次展覽的人士致以最誠摯的謝意。特別感謝鮑皓昕先生設計的展覽海報，以及<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Teresa Coleman</span>女士借出其收藏的道教宗師法衣。
              </p>
              <p style={{ margin: 0 }}>
                展覽及其內容並不反映香港賽馬會慈善信託基金或大館的立場或意見。                            
              </p>
            </div>
            <div className="yj-en-16 yj-lh-14" style={{
              fontWeight: 300,
              color: '#fff',
              textAlign: 'left',
              marginBottom: '1em'
            ...
            <div className="yj-cn-14 yj-lh-14" style={{
              fontWeight: 300,
              color: '#888',
              textAlign: 'left',
              marginBottom: '1em'
              ...
              <p >
註: 是次展覽中引用《傅佩榮解讀易經》（台北，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>2022</span>）的白話中文譯解；英文版本根據衛禮賢（<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Richard Wilhelm</span>）的譯本，由卡利‧貝恩斯（<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Cary F. Baynes</span>）翻譯成英文（普林斯頓，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>1997</span>）。              </p>
      ...
      >
        ...
        <div>
          ...
          <div className="section-title" style={{
            ...
            <div className="section-title-row">
              <h1 className="text-white fw-300 section-title-text yj-lh-12" style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Artist Team</h1>
            </div>
          </div>
          <div className="ct-team-section">
            <div style={{
              ...
              <div style={{ flex: 1 }}>
                ...
                <div className="yj-en-16 yj-lh-12" style={{
                  color: '#fff',
                  fontWeight: 400
                }}>
                  Artist
        ...
        <div>
          ...
          <div className="section-title" style={{
            ...
            <div className="section-title-row">
              <h1 className="text-white fw-300 section-title-text yj-lh-12" style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Tai Kwun Team</h1>
            </div>
          </div>
          <div className="ct-team-section">
        ...
        <div>
          ...
          <div className="section-title" style={{
            ...
            <div className="section-title-row">
              <h1 className="text-white fw-300 section-title-text yj-lh-12" style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Exhibition Design and Production</h1>
            </div>
          </div>
