...
export const metadata: Metadata = {
  metadataBase: new URL('https://www.taikwun.hk'),
  ...
  openGraph: {
    ...
    images: [
      {
        url: assetPath('/images/TK_Yijing_SNS.jpg'),
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [assetPath('/images/TK_Yijing_SNS.jpg')],
  },
  robots: {
    index: true,
    follow: true,
  ...
  icons: {
    icon: assetPath('/images/logo-icon-b.svg'),
  },
};
        ...
        <div className="screen-size-warning">
          <div className="screen-size-warning-box">
            <div className="screen-size-warning-title">
              提示 <span className="fw-300"  style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Notes</span>
            </div>
