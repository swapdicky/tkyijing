            ...
            <div className={`yj-cn-15 text-black fw-300 yj-lh-14 yj-lh-13-m ${currentSlide === 9 ? 'v-fade' : ''}`}  style={{ writingMode: 'vertical-rl',
              ...
              {isMobile ? (
                <>
                  ...
                  <span className="space-before-bracket"></span>︽易經︾<span className="space-after-bracket"></span>在國際世界亦備受尊崇。分別出自馬克萊奇<br/><span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>Thomas McClatchie</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1814–1885</span>年︶<span className="space-after-paren"></span>、理雅各<span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>James Legge</span>，<br/><span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1815–1897</span>年︶<span className="space-after-paren"></span>、尉禮賢<span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>Richard Wilhelm</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1873–1930</span>年︶<span className="space-after-paren"></span>之手的<br/>譯本，將此中國經典傳播至世界。心理學家卡爾‧榮格<span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>Carl Jung</span>，<br/><span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1875–1961</span>年︶<span className="space-after-paren"></span>將此古籍與他提出的<span className="space-before-bracket"></span>﹁共時性﹂<span className="space-after-bracket"></span>概念結合。<br/>先鋒派作曲家約翰‧基治<span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>John Cage</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1912–1992</span>年︶<span className="space-after-paren"></span>根據<br/><span className="space-before-bracket"></span>︽易經︾<span className="space-after-bracket"></span>的處境次序決定音樂創作的隨機性。艾斯班‧艾瑟特<br/><span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>Espen Aarseth</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1965</span>年生︶<span className="space-after-paren"></span>在進行數碼文學研究時，將<span className="space-before-bracket"></span>︽易經︾<span className="space-after-bracket"></span><br/>視為<span className="space-before-bracket"></span>﹁可能是古代最著名的制動文本範例﹂<span className="space-after-bracket"></span>。
                </>
              ) : (
                <>
                  <span className="mt-n-6"></span>︽易經︾被中國歷代思想家不斷詮釋和修訂，<br/>並發展了對其註釋傳統的專門研究和派別。一些<br/>思想家著重卜卦的<span className="mt-n-6"></span>﹁象數﹂<span className="mt-n-6"></span><span style={{ writingMode: 'vertical-rl', textOrientation: 'upright' }}>；</span>另一些深入考究<br/>經典的<span className="mt-n-6"></span>﹁義理﹂<span className="mt-n-6"></span>。此書的影響貫穿整個中國文化史，<br/>持續發揮影響至今。<br/><br/><span className="mt-n-6"></span>︽易經︾在國際世界亦備受尊崇。分別出自<br/>馬克萊奇<span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>Thomas McClatchie</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1814–1885</span>年︶<span className="mt-n-6"></span>、<br/>理雅各<span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>James Legge</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1815–1897</span>年︶<span className="mt-n-6"></span>、尉禮賢<br/><span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>Richard Wilhelm</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1873–1930</span>年︶<span className="mt-n-6"></span>之手的譯本，<br/>將此中國經典傳播至世界。心理學家卡爾‧榮格<br/><span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>Carl Jung</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1875–1961</span>年︶<span className="mt-n-6"></span>將此古籍與他提出的<br/><span className="mt-n-6"></span>﹁共時性﹂<span className="mt-n-6"></span>概念結合。先鋒派作曲家約翰‧基治<br/><span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>John Cage</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1912–1992</span>年︶<span className="mt-n-6"></span>根據<span className="mt-n-6"></span>︽易經︾的處境<br/>次序決定音樂創作的隨機性。艾斯班‧艾瑟特<br/><span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>Espen Aarseth</span>，<span style={{ fontFamily: '"neue-haas-unica", sans-serif', letterSpacing: '0' }}>1965</span>年生︶<span className="mt-n-6"></span>在進行數碼文學<br/>研究時，將<span className="mt-n-6"></span>︽易經︾視為<span className="mt-n-6"></span>﹁可能是古代最著名的<br/>制動文本範例﹂<span className="mt-n-6"></span>。
                </>
              )}
            </div>
          </div>
