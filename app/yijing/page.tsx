            ...
            <div className={`yj-cn-15 text-black fw-300 yj-lh-14 yj-lh-13-m ${currentSlide === 9 ? 'v-fade' : ''}`}  style={{ writingMode: 'vertical-rl',
              ...
              {isMobile ? (
                <>
                  ...
                  <span className="space-before-bracket"></span>︽易經︾<span className="space-after-bracket"></span>在國際世界亦備受尊崇。分別出自馬克萊奇<br/><span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>Thomas McClatchie</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1814–1885</span>年︶<span className="space-after-paren"></span>、理雅各<span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>James Legge</span>，<br/><span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1815–1897</span>年︶<span className="space-after-paren"></span>、尉禮賢<span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>Richard Wilhelm</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1873–1930</span>年︶<span className="space-after-paren"></span>之手的<br/>譯本，將此中國經典傳播至世界。心理學家卡爾‧榮格<span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>Carl Jung</span>，<br/><span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1875–1961</span>年︶<span className="space-after-paren"></span>將此古籍與他提出的<span className="space-before-bracket"></span>﹁共時性﹂<span className="space-after-bracket"></span>概念結合。<br/>先鋒派作曲家約翰‧基治<span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>John Cage</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1912–1992</span>年︶<span className="space-after-paren"></span>根據<br/><span className="space-before-bracket"></span>︽易經︾<span className="space-after-bracket"></span>的處境次序決定音樂創作的隨機性。艾斯班‧艾瑟特<br/><span className="space-before-paren"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>Espen Aarseth</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1965</span>年生︶<span className="space-after-paren"></span>在進行數碼文學研究時，將<span className="space-before-bracket"></span>︽易經︾<span className="space-after-bracket"></span><br/>視為<span className="space-before-bracket"></span>﹁可能是古代最著名的制動文本範例﹂<span className="space-after-bracket"></span>。
                </>
              ) : (
                <>
                  <span className="mt-n-6"></span>︽易經︾被中國歷代思想家不斷詮釋和修訂，<br/>並發展了對其註釋傳統的專門研究和派別。一些<br/>思想家著重卜卦的<span className="mt-n-6"></span>﹁象數﹂<span className="mt-n-6"></span><span style={{ writingMode: 'vertical-rl', textOrientation: 'upright' }}>；</span>另一些深入考究<br/>經典的<span className="mt-n-6"></span>﹁義理﹂<span className="mt-n-6"></span>。此書的影響貫穿整個中國文化史，<br/>持續發揮影響至今。<br/><br/><span className="mt-n-6"></span>︽易經︾在國際世界亦備受尊崇。分別出自<br/>馬克萊奇<span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>Thomas McClatchie</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1814–1885</span>年︶<span className="mt-n-6"></span>、<br/>理雅各<span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>James Legge</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1815–1897</span>年︶<span className="mt-n-6"></span>、尉禮賢<br/><span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>Richard Wilhelm</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1873–1930</span>年︶<span className="mt-n-6"></span>之手的譯本，<br/>將此中國經典傳播至世界。心理學家卡爾‧榮格<br/><span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>Carl Jung</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1875–1961</span>年︶<span className="mt-n-6"></span>將此古籍與他提出的<br/><span className="mt-n-6"></span>﹁共時性﹂<span className="mt-n-6"></span>概念結合。先鋒派作曲家約翰‧基治<br/><span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>John Cage</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1912–1992</span>年︶<span className="mt-n-6"></span>根據<span className="mt-n-6"></span>︽易經︾的處境<br/>次序決定音樂創作的隨機性。艾斯班‧艾瑟特<br/><span className="mt-n-6"></span>︵<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>Espen Aarseth</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', letterSpacing: '0' }}>1965</span>年生︶<span className="mt-n-6"></span>在進行數碼文學<br/>研究時，將<span className="mt-n-6"></span>︽易經︾視為<span className="mt-n-6"></span>﹁可能是古代最著名的<br/>制動文本範例﹂<span className="mt-n-6"></span>。
                </>
              )}
            </div>
          </div>
          ...
          <div
            ...
            <div className="yj-height-half-inner">
              ...
              <div className="yj-cn-16 text-white fw-300 yj-lh-14"  style={{ fontFamily: '"Noto Serif TC", serif' }}>
                ...
                最初，此書將六十四卦的卦象、卦名與卦爻辭集結，名為《周易》，相傳為周文王（公元前十一世紀）所著。《周易》正文逐漸擴展至包含一系列為經作註解和闡釋哲理的「傳」（又稱《十翼》），相信是戰國時期（公元前<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>475–221</span>年）不同作者所撰注。
                </p>
                <p>
        ...
        <>
          ...
          <div
            ...
            <div className="yj-cn-15 text-white fw-300 yj-lh-14"  style={{ fontFamily: '"Noto Serif TC", serif' }}>
              ...
              <p>「河圖」與「洛書」是兩幅中國古代的圖像，代表了對自然秩序的數字詮釋。這兩幅圖像自古流傳，至宋代（<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>960–1279</span>年）增補至《易經》之中。它們與「五行」以及各種對應系統如方位、顏色、干支曆法等相互關聯，以呈現天地萬物在整體規律中的相互依存性。</p>
            </div>
          </div>
      ...
      return (
        ...
        <>
          ...
          <div
            ...
            <div className="yj-cn-15 text-white fw-300 yj-lh-14"  style={{ fontFamily: '"Noto Serif TC", serif' }}>
              <p style={{ marginBottom: '10px' }}>《易經》六十四卦體系，被認為與哥特弗利德·威廉·萊布尼茲 （<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Gottfried Wilhelm Leibniz</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>1646–1716</span>年） 所創的二進制存在關聯，該系統如今被廣泛應用於數位計算領域。</p>
              <p style={{ marginBottom: '10px' }}>萊布尼茲是一名在微積分學作出重大貢獻的德國哲學家和數學家，他被曾前往中國的法國耶穌會傳教士白晉（<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Joachim Bouvet</span>，<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>1656–1730</span>年）引介下認識《易經》。萊布尼茲因中國六十四卦的抽象結構與二進制十分相似而感到著迷，並將此古代符號系統與他的二進制運算建立連結。</p>
              <p>圖例跟據伏羲所創「先天八卦圖」中六十四卦的陣式，將陰以「<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>0</span>」代替，陽以「<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>1</span>」代替，即可得到零至<span style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>63</span>數值的二進制表示法。</p>
            </div>
          </div>
