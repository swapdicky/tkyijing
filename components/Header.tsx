            ...
            <Link href="/exhibition" onClick={() => handleMenuToggle(false)}>
              <div className="group section-title-row border-t cursor-pointer transition-opacity" style={{ borderTopColor: '#888' }}>
                <div className="flex items-baseline gap-3">
                  ...
                  <h2 className="font-light text-white group-hover:text-[#888] transition-colors section-title-text" style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Exhibition</h2>
                </div>
              </div>
            </Link>
            <Link href="/yijing" onClick={() => handleMenuToggle(false)}>
              <div className="group section-title-row cursor-pointer transition-opacity">
                <div className="flex items-baseline gap-3">
                  ...
                  <h2 className="font-light text-white group-hover:text-[#888] transition-colors section-title-text" style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', fontStyle: "italic" }}>Yijing</h2>
                </div>
              </div>
            </Link>
            <Link href="/about" onClick={() => handleMenuToggle(false)}>
              <div className="group section-title-row cursor-pointer transition-opacity">
                <div className="flex items-baseline gap-3">
                  ...
                  <h2 className="font-light text-white group-hover:text-[#888] transition-colors section-title-text" style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>About</h2>
                </div>
              </div>
            </Link>
            <Link href="/creative-team" onClick={() => handleMenuToggle(false)}>
              <div className="group section-title-row cursor-pointer transition-opacity">
                <div className="flex items-baseline gap-3">
                  ...
                  <h2 className="font-light text-white group-hover:text-[#888] transition-colors section-title-text" style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif' }}>Creative Team</h2>
                </div>
              </div>
            </Link>
          </div>
          ...
          <div className="">
            ...
            {/* Footer links and copyright */}
              <div className="flex justify-between items-center px-6" style={{ height: '60px', borderTop: '1px solid #888', borderBottom: '1px solid #888' }}>
                <div className="flex gap-4 text-xs" style={{ fontFamily: '"neue-haas-grotesk-text", sans-serif', color: '#888', fontWeight: '300' }}>
                ...
                <div className="flex gap-3">
                  <a href="https://www.facebook.com/taikwunhk/" target="_blank" className="text-[#888] hover:text-white transition-colors">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/taikwun.hk/" target="_blank" className="text-[#888] hover:text-white transition-colors">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="https://www.youtube.com/@TaiKwun" target="_blank" className="text-[#888] hover:text-white transition-colors">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="flex justify-between items-center px-6" style={{ height: '60px', fontFamily: '"neue-haas-grotesk-text", sans-serif', color: '#888', fontSize: '12px', fontWeight: '300' }}>
