      ...
      >
        <div className="flex flex-col h-full main-menu-wrapper" style={{ paddingTop: isMobile ? '50px' : '89px' }}>
          ...
          <div className="flex-1 flex flex-col justify-top main-menu">
            ...
            <Link href="/acknowledgement" onClick={() => handleMenuToggle(false)}>
              <div className="group section-title-row cursor-pointer transition-opacity">
                <div className="flex items-baseline gap-3">
                  <h2 className="font-normal text-white group-hover:text-[#888] transition-colors section-title-text">鳴謝</h2>
                  <h2 className="font-light text-white group-hover:text-[#888] transition-colors section-title-text" style={{ fontFamily: '"neue-haas-unica", sans-serif' }}>Acknowledgement</h2>
                </div>
              </div>
            </Link>
          </div>
